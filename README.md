...
Development: https://github.com/miguelgrinberg/python-socketio/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4966&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-socketio-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-socketio` can be installed with `conda`:
...
```
mamba install python-socketio
```

It is possible to list all of the versions of `python-socketio` available on your platform with `conda`:
...
```
mamba search python-socketio --channel conda-forge
```
...
mamba repoquery search python-socketio --channel conda-forge

# List packages depending on `python-socketio`:
mamba repoquery whoneeds python-socketio --channel conda-forge

# List dependencies of `python-socketio`:
mamba repoquery depends python-socketio --channel conda-forge
```
